...
using Owin;
using Supreme_Brands.Providers;
        ...
        public async void ConfigureAuth(IAppBuilder app)
        {
            ...
            using (var context = new ApplicationDbContext())
            {
               ...
               // string[] roles = { "sales", "accountant", "driver", "administrator", "merchant", "stock_controller" };
                ...
                await roleManager.CreateAsync(new IdentityRole { Name = "merchant" });
                await roleManager.CreateAsync(new IdentityRole { Name = "stock_controller" });
